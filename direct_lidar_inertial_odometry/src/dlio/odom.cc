...
dlio::OdomNode::OdomNode() : Node("dlio_odom_node") {
  ...
  this->original_scan = pcl::PointCloud<PointType>::ConstPtr(new pcl::PointCloud<PointType>());
  /*this->deskewed_scan = std::make_shared<const pcl::PointCloud<PointType>>();*/
  this->deskewed_scan = pcl::PointCloud<PointType>::ConstPtr(new pcl::PointCloud<PointType>());
  /*this->current_scan = std::make_shared<const pcl::PointCloud<PointType>>();*/
  this->current_scan = pcl::PointCloud<PointType>::ConstPtr(new pcl::PointCloud<PointType>());
  /*this->submap_cloud = std::make_shared<const pcl::PointCloud<PointType>>();*/
  this->submap_cloud = pcl::PointCloud<PointType>::ConstPtr(new pcl::PointCloud<PointType>());
...
void dlio::OdomNode::publishCloud(pcl::PointCloud<PointType>::ConstPtr published_cloud, Eigen::Matrix4f T_cloud) {
  ...
  pcl::PointCloud<PointType>::Ptr deskewed_scan_t_(new pcl::PointCloud<PointType>());
...
void dlio::OdomNode::getScanFromROS(const sensor_msgs::msg::PointCloud2::SharedPtr& pc) {
  ...
  pcl::PointCloud<PointType>::Ptr original_scan_(new pcl::PointCloud<PointType>());
...
void dlio::OdomNode::deskewPointcloud() {
  ...
  pcl::PointCloud<PointType>::Ptr deskewed_scan_(new pcl::PointCloud<PointType>(1, this->original_scan->points.size()));
...
void dlio::OdomNode::computeConcaveHull() {
  ...
  this->concave_hull.setInputCloud(boost::shared_ptr<const pcl::PointCloud<PointType>>(
    cloud.get(),
